...
struct CropDetectionPipeline: Sendable {
    ...
    func stages(for settings: CropSettings) -> [CropDetectionStage] {
        ...
        switch settings.businessProfile {
        case .filmScan:
            automaticStages = [.lightGaps, .projectionSeparators, .filmFrames, .visionRectangles, .foregroundComponents]
        case .gridPhoto:
            automaticStages = [.projectionSeparators, .lightGaps, .foregroundComponents, .visionRectangles, .filmFrames]
        case .balanced:
            automaticStages = [.lightGaps, .filmFrames, .projectionSeparators, .visionRectangles, .foregroundComponents]
        }
